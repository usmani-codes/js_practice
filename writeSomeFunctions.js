...
const isPalindrome = (str) => {
    ...
    if (str === reversedStr) console.log('yes the string is palindrome: ',str); else console.log("no it's not a palindrome")
}
isPalindrome(string)
...
// 9. Write a function that sorts an array of objects based on a specified property.
